f4fApp.addController("DestaqueController", function($this, $element) {
    $this.onInit = function() {
        f4fApp.buildCrud($this, $element, {
            list: ["GET", "../api/v1/destaque"],
            insert: ["POST", "../api/v1/destaque"],
            find: ["GET", "../api/v1/destaque/{id}"],
            delete: ["DELETE", "../api/v1/destaque/{id}"],
            update: ["PUT", "../api/v1/destaque/{id}"],
            toggle: ["PUT", "../api/v1/destaque/{id}/ativar"]
        });
